    ...
    <div className="p-4">
      ...
      <div className="mb-6 rounded-xl border border-border bg-card p-3">
        <p className="mb-2 flex items-center gap-1.5 text-sm font-medium">
          <UserPlus className="size-4 text-primary" /> {t("inviteCodePrompt")}
        </p>
      ...
      <Tabs defaultValue="public-equbs" className="w-full">
        <TabsList className="grid w-full grid-cols-2 mb-6">
          <TabsTrigger value="public-equbs">{t("publicEqubs")}</TabsTrigger>
          <TabsTrigger value="my-equbs">{t("myEqubs")}</TabsTrigger>
        </TabsList>
      ...
      <Card className="w-full transition-colors hover:bg-muted/40">
        <CardContent className="flex flex-col gap-3">
          ...
          <p className="flex items-center gap-1.5 text-sm text-muted-foreground">
            ...
            {equb.maxMembers != null && `/${equb.maxMembers}`} {t("membersCount")}
          </p>
        </CardContent>
      </Card>
    </Link>
